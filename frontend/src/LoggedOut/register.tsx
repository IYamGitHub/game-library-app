...
import { AVATARS } from '../LoggedIn/Profile/avatarModal';
    ...
    <div className="h-100 bg-gla-medium-blue">
      ...
      <div className="content d-flex bg-login register-bg-image">
        <div className="login-section d-flex flex-column flex-grow-1 opacity-100">
          <h1 className={`text-center ${error ? 'mb-2' : 'mb-4'}`}>
            Sign up today!
          </h1>
          {error && (
            <div
          ...
          <button className="btn btn-light ms-auto me-0 mt-4" onClick={signup}>
            Submit
          </button>
